  ...
  return (
    <div className="app">
      <div className="nav__container">
            <ul>
                <li className="nav__item"><span className="span_description">About me</span><a href="#"> <img className="nav__link" src="https://cdn3.iconfinder.com/data/icons/emoticon-emoji-1/50/Omg-256.png" alt="icon"/> </a></li>
